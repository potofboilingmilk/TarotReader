...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2024 at 06:00 PM
...
INSERT INTO `reading` (`ReadingID`, `UserID`, `SpreadID`, `ReadingFlagged`, `AltInterpret`, `TarotA`, `TarotB`, `TarotC`, `TarotD`, `TarotE`, `TarotF`, `TarotG`, `TarotH`, `TarotI`, `TarotJ`) VALUES
(1, 1, 1, 1, 'Hello World!', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `spread` (`SpreadID`, `SpreadName`, `MeaningA`, `MeaningB`, `MeaningC`, `MeaningD`, `MeaningE`, `MeaningF`, `MeaningG`, `MeaningH`, `MeaningI`, `MeaningJ`) VALUES
(1, 'One Card Spread | \"Answer to a Question\"', 'This card represents the tarot\'s general attitude or response to the question that the user asked.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Two Card Spread | \"Let Go & Welcome\"', 'This card represents what the user should let go of, in order to proceed with life.', 'This card represents what the user should embrace, in order to proceed with life.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `tarot` (`TarotID`, `TarotName`, `TarotImage`, `TarotMeaning`) VALUES
(1, 'Ace of Wands', 'NO_IMAGE', 'The Ace of Wands often represents opportunity, inspiration, and an awakening.');
...
INSERT INTO `user` (`UserID`, `UserMail`, `UserPass`, `UserRestricted`, `UserPower`) VALUES
(1, 'usermail@mail.mail', 'password', 0, 1),
(2, 'consultant@consultant.consultant', 'password', 0, 2);
...
--
ALTER TABLE `reading`
  MODIFY `ReadingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `spread`
--
ALTER TABLE `spread`
  MODIFY `SpreadID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
